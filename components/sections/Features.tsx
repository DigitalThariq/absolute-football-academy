...
const features = [
  {
    ...
    description:
      "We build resilient leaders on and off the pitch through discipline, respect, and emotional intelligence training embedded in every session.",
    detail: "Life skills beyond the game",
  ...
  },
  {
    ...
    description:
      "A high-performance environment designed to push players toward professional standards, tournament success, and personal bests.",
    detail: "Pro-standard methodology",
  ...
  },
  {
    ...
    description:
      "Modern sports science meets data-driven drills — focused on speed, agility, and technical precision for maximum physical output.",
    detail: "Science-backed training",
      ...
      <Container ref={ref}>
        ...
        >
          <span className="inline-block font-display font-bold text-[10px] uppercase tracking-[0.25em] text-accent mb-4">
            Why Absolute Football Academy
          </span>
          <h2 className="font-display text-display-md text-foreground leading-tight">
            More than a{" "}
            <span className="text-foreground-3">football club.</span>
          </h2>
        </motion.div>
